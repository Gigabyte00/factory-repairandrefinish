 ...
 * Logs clicks to revenue_events table via /api/track-click then routes
 * through /go/[slug] (bot filter + server-side click logging + 302 to affiliate).
 *
 ...
 * @example
 * <p>
 *   Check out <OfferLink offerId="..." siteId="..." offerSlug="..." affiliateUrl="...">TurboTax</OfferLink> for
 *   easy online filing.
 * </p>
 */
