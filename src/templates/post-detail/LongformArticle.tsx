...
import { Prose, Callout, LastUpdated, ProductCallout, LeadMagnetCTA, AudienceFit, Sources, Changelog, RelatedInline, BountyCTA, type ChangelogEntry } from '@/components/content';
          ...
          <article>
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6 md:p-8">
                ...
                {part2 && (
                  <>
                    <InlineOptIn siteId={siteId} niche={site.niche} magnet={inlineMagnet} />
                    <Prose className="prose-lg">
                      <ReactMarkdown remarkPlugins={[remarkGfm]} components={affiliateLinkComponents(post.slug)}>
                        {part2}
                      </ReactMarkdown>
                ...
                {part3 && (
                  <>
                    <RelatedInline posts={relatedPosts as any} />
                    <Prose className="prose-lg">
                      <ReactMarkdown remarkPlugins={[remarkGfm]} components={affiliateLinkComponents(post.slug)}>
                        {part3}
                      </ReactMarkdown>
