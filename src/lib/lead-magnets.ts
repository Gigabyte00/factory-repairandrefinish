...
export const LEAD_MAGNETS: Record<string, LeadMagnet> = {
  ...
  'ebikerevolt-buyers-checklist': {
    slug: 'ebikerevolt-buyers-checklist',
    title: "The eBike Buyer's Checklist: 12 Questions Before You Spend $1,000+",
    description: '12 essential questions to ask before buying any eBike. Covers motor wattage, battery range, frame fit, brake systems, warranty traps, and the red flags that mean walk away. Use it on every test ride.',
    subline: 'Avoid the 4 most expensive eBike mistakes',
    icon: '⚡',
    ctaText: 'Download Free Checklist',
    downloadLabel: "eBike Buyer's Checklist (Markdown)",
  },
  'audible-credit-strategy-guide': {
    slug: 'audible-credit-strategy-guide',
    title: 'The Audible Credit Strategy Guide: Never Waste a Credit Again',
    description: 'How to extract maximum value from every Audible credit: when to spend vs. save, how to spot $40+ books, return-policy hacks, and the 7-genre rotation that keeps your library fresh year-round.',
    subline: 'Average reader saves $180/year',
    icon: '🎧',
    ctaText: 'Get Free Guide',
    downloadLabel: 'Audible Credit Strategy Guide (Markdown)',
  },
  'dubai-chocolate-masterclass': {
    slug: 'dubai-chocolate-masterclass',
    title: 'The Dubai Chocolate Masterclass: 5 Recipes from $3 to $40',
    description: '5 tested Dubai chocolate recipes spanning every budget — from a $3 stovetop knafeh bar to a $40 saffron-pistachio truffle plate. Ingredient sourcing, tempering tips, and TikTok-friendly plating.',
    subline: '5 recipes, every budget level',
    icon: '🍫',
    ctaText: 'Get Free Recipes',
    downloadLabel: 'Dubai Chocolate Masterclass (Markdown)',
  },
  'first-brew-blueprint': {
    slug: 'first-brew-blueprint',
    title: 'The First Brew Blueprint: 5-Gallon Amber Ale, Start to Sip',
    description: 'Complete walkthrough of your first 5-gallon homebrew: full equipment list with budget alternatives, ingredient shopping list, hour-by-hour brew day timeline, fermentation troubleshooting, and the exact amber ale recipe that wins beginner competitions.',
    subline: '4 weeks from grain to glass',
    icon: '🍺',
    ctaText: 'Download Free Blueprint',
    downloadLabel: 'First Brew Blueprint (Markdown)',
  },
};
