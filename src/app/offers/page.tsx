  ...
  return (
    <>
      <PageHero
        ...
        title={`${site.niche || 'Products'} we've tested & recommend`}
        subtitle="Hand-picked products with our editorial verdict and the best price right now. Every offer here has been reviewed by our team — no pay-to-play rankings."
        meta={
          <>
            <span>{offers.length} active {offers.length === 1 ? 'offer' : 'offers'}</span>
            <span className="hidden sm:inline opacity-50">·</span>
            <span>Independent picks, no sponsored placements</span>
          </>
        }
      />
