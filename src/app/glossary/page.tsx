...
export default async function GlossaryIndexPage() {
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow={`${site.niche || site.name} Glossary`}
        title={`${site.niche || site.name} Terms & Definitions`}
        subtitle={`${items.length} terms defined — an authoritative reference for understanding the most important concepts in ${site.niche || site.name}.`}
      />
