  ...
  return (
    <>
      ...
      <PageHero
        ...
        title="The People Behind the Reviews"
        subtitle={`The experts and enthusiasts who write for ${site.name} — all independent, all focused on the products they cover.`}
      />
