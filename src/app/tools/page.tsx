...
export default async function ToolsPage() {
  ...
  // (Per-site signature calculators are data-driven via calculator_templates; none are seeded yet.)
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <PageHero
        ...
        subtitle={`Calculators, comparisons, and matchers to help you pick the right ${site.niche?.toLowerCase() || 'product'}.`}
      />
